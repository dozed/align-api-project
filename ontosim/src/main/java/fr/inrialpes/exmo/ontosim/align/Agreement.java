/**
 *   Copyright 2011-2012 INRIA, Université Pierre Mendès France
 *   
 *   Agreement.java is part of OntoSim.
 *
...
public class Agreement extends AD {

    public Agreement(BasicOntologyNetwork oo) {
	super(oo);
    }
