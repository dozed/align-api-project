...
public class BasicCell implements Cell, Comparable<Cell> {
    ...
    public boolean equals(Cell c) {
        if (c == null) return false;
            ...
            return (object1.equals(((BasicCell) c).getObject1()) && object2.equals(((BasicCell) c).getObject2()) && strength == ((BasicCell) c).getStrength() && (relation.equals(((BasicCell) c).getRelation())));
    }
